...
socat UNIX-RECVFROM:/run/vpp/read-punt.socket,reuseaddr,fork TCP-CONNECT:"${VPP_SSWAN_IP}":"${VPP_SSWAN_PORT}" &
socat TCP-LISTEN:"${VPP_SERVER_PORT}",reuseaddr,fork UNIX-SENDTO:/run/vpp/punt.socket &
